...
export function FAQs() {
  ...
  return (
    <div className="w-full py-10 bg-violet-50 bg-gradient-to-b from-purple-950 from-[20rem] to-violet-50 to-[20rem]">
      <div className="bg-white rounded-2xl p-10 w-[32.5rem] mt-[8.46875rem] flex flex-col mx-auto shadow-xl shadow-black/5">
